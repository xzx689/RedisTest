...
public class ExecutorHashTestGet {
	...
	class SumCalculator implements Callable<Long> {
		...
		public Long call() throws Exception {
			Long count=testHash(this.start,this.end);
	...
	public static void main(String[] args) {
		...
		ExecutorHashTestGet calc = new ExecutorHashTestGet();  
		//设置数据量
		int count=100000;
		calc.sum(count);  
